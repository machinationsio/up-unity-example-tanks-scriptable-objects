...
namespace MachinationsUP.Engines.Unity.BackendConnection
{
    public class SocketIOClient
    {
        ...
        public void InitSocket ()
        {
            ...
            Debug.Log("Instantiated SocketIO with Hash: " + _socket.GetHashCode());
        ...
        private void ExecuteThread ()
        {
            ...
            if (_connectionAborted && _reconnectionAttempts <= RECONNECTION_ATTEMPTS)
            {
                ...
                Debug.Log("Attempt #" + _reconnectionAttempts + " to reconnect to Machinations.");
        ...
        public void EmitMachinationsInitRequest ()
        {
            ...
            if (!initRequestData)
            {
                Debug.Log("EmitMachinationsInitRequest: no data has been requested.");
                return;
            }
        ...
        {
            Debug.Log("[SocketIO::" + _socket.GetHashCode() + "] !!!! Error received: " + e.name + " DATA: " + e.data + " ");
            HandleConnectionFailure(true);
        }

        private void OnSocketClose (SocketIOEvent e)
        {
            Debug.Log("[SocketIO::" + _socket.GetHashCode() + "] !!!! Close received: " + e.name + " DATA:" + e.data);
            HandleConnectionFailure(true);
        }
