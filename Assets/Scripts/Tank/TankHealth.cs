...
public class TankHealth : MonoBehaviour
{
    ...
    public GameObject m_EnemySpeedIncreasedBuffIcon;
    ...
    private void OnEnable ()
    {
        ...
        m_TankStatsEnemy.CurrentSpeedBuff = 0;
        //Enemy Shells.
    ...
    {
        //Won't kill due to life reduction.
        if (GameState.Instance.PlayerMustTakeDamage != 0)
        {
            amount = GameState.Instance.PlayerMustTakeDamage;
            GameState.Instance.PlayerMustTakeDamage = 0;
            //Only apply damage if it won't kill the Player.
    ...
    private void OnDeath ()
    {
        ...
        var rnd = Random.Range(0, dropRates.Count);
