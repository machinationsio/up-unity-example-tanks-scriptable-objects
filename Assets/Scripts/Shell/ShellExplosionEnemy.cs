...
public class ShellExplosionEnemy : MonoBehaviour
{
    ...
    private void OnCollisionEnter (Collision collision)
    {
        ...
        for (int i = 0; i < colliders.Length; i++)
        {
            ...
            float projectileRadius = m_ShellStatsEnemy.Radius.CurrentValue + m_ShellStatsEnemy.CurrentExplosionRadiusBuff;
            float projectileForce = m_ShellStatsEnemy.Force.CurrentValue + m_ShellStatsEnemy.CurrentExplosionForceBuff;
            float projectileDamage = m_ShellStatsEnemy.Damage.CurrentValue;
